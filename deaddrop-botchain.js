...
export async function connectWallet() {
  ...
  if (network.chainId !== BOT_CHAIN_MAINNET_ID) {
    try {
      ...
      // 4902 = chain not added yet. Some wallets (especially mobile
      // injected providers) don't set switchError.code reliably and
      // instead nest it or just return a generic RPC error with this
      // message, so we also fall back on the message text.
